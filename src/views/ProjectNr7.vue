  ...
  <section id="projectNr7">
    <div class="w-11/12 lg:w-1/2 container mx-auto ">
      ...
      <img class=" mx-auto mt-8 lg:mt-20 shadow-img"
           src="../assets/slider/05_home.jpg">
      <h1 class="text-3xl py-2 lg:py-3">Neues Wohnen</h1>
      <h2 class="text-xl py-2 lg:py-3 font-semibold">Lorem ipsum dolor sit amet, consetetur sadipscing elitr</h2>
      <h5 class="text-md font-semibold">Augustastraße | Herne 1.PREIS</h5>
      <article class=" xl:flex">
        ...
        <div class="my-auto">
          <img class="mx-auto shadow-img" v-lazy="{src: `${require('../assets/projects/project5/01_project.jpg')}`}"
          >
        </div>
      </article>
      <img class="mt-8 mb-2 shadow-img"

           v-lazy="{src: `${require('../assets/projects/project5/02_project.jpg')}`}"
      >
      <img class="my-4 shadow-img"

           v-lazy="{src: `${require('../assets/slider/05_home.jpg')}`}"
      >
      <img class="my-4 shadow-img"
      ...
      <article class="flex">
        <img class="w-1/2 pr-1"
             ...
             v-lazy="{src: `${require('../assets/projects/project5/01_project.jpg')}`}"
        >
